...
let car1 = new Car(198,"kia",123,"fortuner");
car1.disp();
...
let evCars=[
new EV(21,"Ford","Mustang","22L",400)
];

console.log(evCars);

evCars.push(new EV(25,"dodge","viper","8L",500));
console.log(evCars);

evCars.unshift(new EV(28,"audi","car","6L",350));
console.log(evCars);

evCars.splice(1,0,new EV(20,"beetle","Volkswagen","8L",400));
console.log(evCars);
